...
def get_quiz(text, model='gpt-3.5-turbo'):
    prompt = f"""
        Create a five question, multiple-choice quiz on the text below. Include all the correct answers at the end of the quiz, after all the questions.
        '''{text}'''
        """
    print(f'Prompt:\n{prompt}')
...
# test on sample text
nihilism_text = '''Nihilism is a family of views within philosophy that rejects generally accepted or fundamental aspects of human existence, such as knowledge, morality, or meaning. The term was popularized by Ivan Turgenev and more specifically by his character Bazarov in the novel Fathers and Sons.
